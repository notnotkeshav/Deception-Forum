...
<head>
    ...
    <title>⛧ Access Denied - Red Skull ⛧</title>
...
<body>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            if (browser.isValid) {
                // Redirect to main site if Firefox desktop
                window.location.href = '/home'; // Change this to your main page
            }
        });
    </script>
</body>
